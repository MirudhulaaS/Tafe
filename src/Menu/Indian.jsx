...
const Indian = () => {
    ...
    return (
        <Card className="menu-container" style={{backgroundColor: 'rgb(234, 255, 249)'}}>
            <Order />
            <h1 className="order-title">Indian Chai</h1>
            <div className="col-4">
                <Card className="tea-card" style={cardStyle}>
                    <img src="tea/tea-1.jpeg" alt="Green Tea" className="tea-img" />
                ...
                <br/>
                <Card className="tea-card" style={cardStyle}>
                    <img src="tea/tea-2.webp" alt="Plain Tea" className="tea-img" />
                ...
                <br/>
                <Card className="tea-card" style={cardStyle}>
                    <img src="tea/tea-3.jpeg" alt="Lemon Tea" className="tea-img" />
                ...
                <br/>
                <Card className="tea-card" style={cardStyle}>
                    <img src="tea/tea-4.jpeg" alt="Ginger Tea" className="tea-img" />
                ...
                <br/>
                <Card className="tea-card" style={cardStyle}>
                    <img src="tea/tea-5.jpeg" alt="White Tea" className="tea-img" />
                ...
                <Card className="tea-card" style={cardStyle}>
                    <img src="tea/tea-6.jpeg" alt="Matcha Tea" className="tea-img" />
                ...
                <br/>
                <Card className="tea-card" style={cardStyle}>
                    <img src="tea/tea-7.avif" alt="Black Tea" className="tea-img" />
                ...
                <br/>
                <Card className="tea-card" style={cardStyle}>
                    <img src="tea/tea-8.jpeg" alt="Oolong Tea" className="tea-img" />
                ...
                <br/>
                <Card className="tea-card" style={cardStyle}>
                    <img src="tea/tea-9.jpeg" alt="Chamomile Tea" className="tea-img" />
                ...
                <br/>
                <Card className="tea-card" style={cardStyle}>
                    <img src="tea/tea-10.jpeg" alt="Rooibos Tea" className="tea-img" />
                ...
                <Card className="tea-card" style={cardStyle}>
                    <img src="tea/tea-11.jpeg" alt="Lavender Tea" className="tea-img" />
                ...
                <br/>
                <Card className="tea-card" style={cardStyle}>
                    <img src="tea/tea-12.jpeg" alt="Yellow Tea" className="tea-img" />
                ...
                <br/>
                <Card className="tea-card" style={cardStyle}>
                    <img src="tea/tea-13.jpeg" alt="Hibiscus Tea" className="tea-img" />
                ...
                <br/>
                <Card className="tea-card" style={cardStyle}>
                    <img src="tea/tea-14.jpeg" alt="Peppermint Tea" className="tea-img" />
                ...
                <br/>
                <Card className="tea-card" style={cardStyle}>
                    <img src="tea/tea-15.jpeg" alt="Cinnamon Tea" className="tea-img" />
